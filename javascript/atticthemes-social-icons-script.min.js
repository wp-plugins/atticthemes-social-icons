(function(f){f(".atticthemes-social-icon-sets-wrapper").on("click","li.atticthemes-social-icon-add-icon",b);function d(){f(".atticthemes-social-icon-sets-wrapper").off("dblclick","li.atsi",a);f(".atticthemes-social-icon-sets-wrapper").on("dblclick","li.atsi",a);}d();function a(){var m=f(this);var l=f(".atticthemes-social-icon-editor-wrapp");l.find(".atticthemes-social-icon-editor-title").text(m.attr("title"));var k=l.find("input.atticthemes-social-icon-link-input");k.val(m.attr("data-link"));setTimeout(function(){k.focus().select();},50);var n=l.find(".atticthemes-social-icon-editor-status-bar");n.text("");l.data("icon",m);l.fadeIn();k.off("keyup");k.on("keyup",function(o){o.preventDefault();if((o.keyCode||o.which)==13){l.find(".atticthemes-social-icon-editor-done-button").trigger("click");}else{if((o.keyCode||o.which)==27){l.find(".atticthemes-social-icon-editor-cancel-button").trigger("click");}}});}function b(){var n=f(this);var p=f(".atticthemes-social-icon-set-container").has(this);
var m=p.attr("data-set-id");var l=f(".atticthemes-social-icons-list-wrapp");l.fadeIn("fast");l.data("set_id",m);var o=f(".atticthemes-social-icons-list-close",l);o.one("click",k);function k(){l.fadeOut("fast");}}f(".atticthemes-social-icons-list").on("click","li",function(){var m=f(this);var p=m.clone();var l=f(".atticthemes-social-icons-list-wrapp");var n=l.data("set_id");var r=f('.atticthemes-social-icon-set-container[data-set-id="'+n+'"]');var o=f(".atticthemes-social-icon-add-icon",r);o.before(p);var k=l.find(".atticthemes-social-icons-list-preloader");k.fadeIn("fast");var q=r.hasClass("new-atticthemes-social-icon-set");r.removeClass("new-atticthemes-social-icon-set");if(q){c();}g(function(s){if(s.status==="success"||s.status==="no-change"){k.fadeOut({duration:200,complete:function(){console.log("icon added");}});}else{if(s.status==="error"){k.fadeOut({duration:200});f(".atticthemes-social-icons-list-status-bar").text(s.message);}}});});f(".atticthemes-social-icon-editor").on("click",".atticthemes-social-icon-editor-cancel-button",function(){var k=f(".atticthemes-social-icon-editor-wrapp");
